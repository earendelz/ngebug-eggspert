...
<body>
  ...
  <div class="modal fade" id="form_tambah_penjualantelur" tabindex="-1" aria-labelledby="formPenjualantelurLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="tambahPenjualantelurForm">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="jumlahTelur" placeholder="Masukkan jumlah butir telur terjual">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="hargaTelur" placeholder="Masukkan Harga Telur per Butir">
            </div>
            <div class="mb-3">
          ...
          <script>
            $(document).ready(function () {
              $('#tambahPenjualantelurForm').on('submit', function (e) {
                ...
                $.ajax({
                  url: 'https://eggspert.site/api/penjualantelurku', // Replace with the correct route
                  method: 'POST',
                  data: jsonData,
