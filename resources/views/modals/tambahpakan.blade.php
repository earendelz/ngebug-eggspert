...
<body>
  ...
  <div class="modal fade" id="form_tambah_pakan" tabindex="-1" aria-labelledby="formPakanLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="formVaksinasiLabel" style="color: #AE7B3D;">Tambah Pakan Ayam</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="tambahPakanForm">
            <div class="mb-3">
              <label for="jenisPakan" class="form-label">Jenis Pakan</label>
              <input type="text" class="form-control" id="jenisPakan" placeholder="Masukkan jenis pakan">
            </div>
          ...
          <script>
            $(document).ready(function () {
              $('#tambahPakanForm').on('submit', function (e) {
                e.preventDefault(); // Prevent default form submission
                // Get form data
                var formData = {
                  jenis_pakan: $('#jenisPakan').val(),
                };
                ...
                $.ajax({
                  url: 'https://eggspert.site/api/pakanku', // Replace with the correct route
                  method: 'POST',
                  data: jsonData,
                  ...
                  success: function(response) {
                    ...
                    $('#formPakanModal').modal('hide');
                    alert('Data Pakan berhasil ditambahkan!');
                    setTimeout(function() {
                      location.reload();
                    }, 1000);
