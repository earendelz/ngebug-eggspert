...
<body>
  ...
  <div class="modal fade" id="form_edit_penjualanayam" tabindex="-1" aria-labelledby="formPenjualanayamLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="formPenjualanayamLabel" style="color: #AE7B3D;">Edit Penjualan Ayam`</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="edit_penjualanayam_form">
            <div class="mb-3">
