...
<body>
  ...
  <div class="modal fade" id="form_tambah_laporanayam" tabindex="-1" aria-labelledby="formLaporanayamLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="formLaporanayamLabel" style="color: #AE7B3D;">Tambah Laporan Ayam</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="tambahLaporanayamForm">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="jenisLaporan" id="kelahiran" value="Kelahiran">
                  <label class="form-check-label" for="manual" style="color: #AE7B3D;">Kelahiran</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="jenisLaporan" id="kematian" value="Kematian">
                  <label class="form-check-label" for="otomatis" style="color: #AE7B3D;">Kematian</label>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="tanggalPeristiwa" placeholder="Pilih tanggal peristiwa">
            </div>
          ...
          <script>
            $(document).ready(function () {
              $('#tambahLaporanayamForm').on('submit', function (e) {
                ...
                var formData = {
                  ...
                  jenis_laporan: $('input[name="jenisLaporan"]:checked').val(),
                  jumlah_ayam: parseInt($('#jumlahAyam').val()),
                ...
                $.ajax({
                  url: 'https://eggspert.site/api/laporanayamku', // Replace with the correct route
                  method: 'POST',
                  data: jsonData,
