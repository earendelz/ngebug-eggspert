...
<body>
  ...
  <div class="modal fade" id="form_edit_panentelur" tabindex="-1" aria-labelledby="formPanentelurLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="formPanentelurLabel" style="color: #AE7B3D;">Edit Panen Telur</h4>
        ...
        <div class="modal-body">
          <form id="edit_panentelur_form">
            ...
            <div class="mb-3">
              <label for="egudang" class="form-label">Gudang</label>
              <select name="gudang" class="form-control" id="egudang" placeholder="Pilih Gudang">
                <option value="1"></option>
              </select>   
            </div>
            <div class="mb-3">
              <label for="ejumlahTelur" class="form-label">Jumlah Telur</label>
              <input type="text" class="form-control" id="ejumlahTelur" placeholder="Masukkan jumlah telur">
            </div>
            <div class="mb-3">
              <label for="ekondisiTelur" class="form-label">Kondisi Telur</label>
              <input type="text" class="form-control" id="ekondisiTelur" placeholder="Masukkan Kondisi Telur">
            </div>
            <div class="mb-3">
              <label for="etanggalPanen" class="form-label">Tanggal Panen Telur</label>
              <input type="text" class="form-control" id="etanggalPanen" placeholder="Pilih tanggal">
            </div>
            <div class="mb-3">
              <label for="ememo" class="form-label">Keterangan</label>
              <textarea class="form-control" id="ememo" name="ememo" placeholder="Tambahkan Keterangan" oninput="adjustTextareaHeight(this)"></textarea>
            </div>
