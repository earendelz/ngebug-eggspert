            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: #FFD56A;" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('gudang.index') }}" style="color: black;">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt text-dark"></i></div>
                            Edit Gudang
                        </a>
                        ...
                        <div class="card-body">
                            <a href="{{ route('products.create') }}">
                                <button class="btn btn-primary mb-3"
                                    style="background-color: #C0833D; border-color: #C0833D;">Tambah Kandang</button>
                            </a>
