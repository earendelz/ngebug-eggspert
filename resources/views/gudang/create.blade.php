                        ...
                        <body>
                            <form action="{{ route('gudang.store') }}" method="POST">
                                ...
                                <div class="mx-3 mb-3">
                                    ...
                                    <input type="number" id="egg_count" name="egg_count" required
                                        class="form-control">
                                    <br>
                                </div>
                                <div class="mx-3 mb-3">
                                    <label for="chicken_breed" class="mb-1">Ras Ayam:</label>
                                    <input type="text" id="chicken_breed" name="chicken_breed" required
                                        class="form-control">
                                    <br>
                                </div>
                                <button type="submit" class="btn btn-primary mb-3 mx-3"
                                    style="background-color: #C0833D; border-color: #C0833D;">Simpan</button>
                            </form>
                        </body>
