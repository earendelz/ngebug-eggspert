                    ...
                    <div class="card mb-4">
                        ...
                        <body>
                            <form action="{{ route('gudang.update', $gudang->id) }}" method="POST">
                                ...
                                @method('PUT')
                                <div class="mx-3 mb-3">
                                    <label for="name" class="mb-1">Nama Gudang:</label>
                                    <input type="text" id="name" name="name" value="{{ $gudang->name }}"
                                        class="form-control">
                                    <br>
                                </div>
                                <div class="mx-3 mb-3">
                                    <label for="date" class="mb-1">Tanggal:</label>
                                    <input type="text" id="date" name="date" value="{{ $gudang->date }}"
                                        class="form-control">
                                    <br>
                                </div>
                                <div class="mx-3 mb-3">
                                    <label for="egg_count" class="mb-1">Jumlah Telur:</label>
                                    <input type="number" id="egg_count" name="egg_count"
                                        value="{{ $gudang->egg_count }}" class="form-control">
                                    <br>
                                </div>
                                <div class="mx-3 mb-3">
                                    <label for="chicken_breed" class="mb-1">Ras Ayam:</label>
                                    <input type="text" id="chicken_breed" name="chicken_breed"
                                        value="{{ $gudang->chicken_breed }}" class="form-control">
                                    <br>
                                </div>
