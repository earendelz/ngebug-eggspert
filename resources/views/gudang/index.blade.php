            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: #FFD56A;" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{ route('products.index') }}" style="color: black;">
                        ...
                        <div class="card-body">
                            <a href="{{ route('gudang.create') }}">
                                <button class="btn btn-primary mb-3"
                                    style="background-color: #C0833D; border-color: #C0833D;">Tambah Gudang</button>
                            </a>
                                ...
                                <tbody>
                                    @foreach ($gudangs as $gudang)
                                        <tr>
                                            ...
                                            <td>{{ $gudang->name }}</td>
                                            <td>{{ $gudang->date }}</td>
                                            <td>{{ $gudang->egg_count }}</td>
                                            <td>{{ $gudang->chicken_breed }}</td>
